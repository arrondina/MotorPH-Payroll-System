...
public class User extends Employee {
    ...
    public static User loadFromCSV(String csvFilename, String enteredUsername, String enteredRole) 
        ...
        try (CSVReader reader = new CSVReader(new FileReader("C:\\Users\\Anna\\Downloads\\employeeAccounts.csv"))) {
            ...
            while ((line = reader.readNext()) != null) {
                ...
                if (username.equals(enteredUsername) && role.equalsIgnoreCase(enteredRole)) {
