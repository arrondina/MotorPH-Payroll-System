...
public class FrmLogin extends javax.swing.JFrame {
    ...
    private void Login(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Login
        ...
        try {
            ...
            User loggedInUser = User.loadFromCSV("C:\\Users\\Anna\\Downloads\\employeeAccounts.csv", enteredUsername, enteredPassword);
            if (loggedInUser != null && loggedInUser.authenticate(enteredUsername, enteredPassword)) {
                ...
                if (role.equalsIgnoreCase("hrstaff")) {
                    ...
                    Employee loadedEmployee = Employee.loadDetails("employeeDetails.csv", enteredUsername);
                    ...
                    if (loadedEmployee != null) {
                        ...
                        employeeHome.setEmployee(loadedEmployee, loadedPayslip);
