 ...
 * @author Rosh
 */
public class FrmApprove extends javax.swing.JDialog {

    /**
     * Creates new form FrmAddEmployee
     * @param leave
     */
    public FrmApprove(LeaveManagement leave) {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblTitle.setText("Approve Leave Request");
    ...
    private void ApproveRequest(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ApproveRequest
        ...
        try {
            leave.approveLeave(csvFilename, String.valueOf(employeeID), "Approved");
